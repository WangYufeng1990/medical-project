...
import { ImmunizationVO } from '../../../types/entities'
import styles from '../../shared.module.css'

const STATUS_COLOR: Record<string, string> = { completed: '#67C23A', refused: '#F56C6C', contraindicated: '#E6A23C' }

export default function PatientImmunizations() {
  const { data, isLoading } = useQuery({
    queryKey: ['me', 'immunizations'],
    queryFn: () => http.get<ImmunizationVO[]>('/patient/me/immunizations'),
  })
