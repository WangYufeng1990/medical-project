...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedPatients() {
        ...
        jdbcTemplate.update(patientSql,
                ...
                "Mary Anderson", AesCryptoUtil.encrypt("312-555-0102"), "Spouse",
        ...
        jdbcTemplate.update(patientSql,
                ...
                "active", "Dr. Sarah Mitchell",
                AesCryptoUtil.encrypt("312-555-0201"), AesCryptoUtil.encrypt("312-555-0202"), AesCryptoUtil.encrypt("maria.garcia@email.com"),
                "200 E Randolph St", null, "Chicago", "IL", "60601",
                "Carlos Garcia", AesCryptoUtil.encrypt("312-555-0203"), "Spouse",
        ...
        jdbcTemplate.update(patientSql,
                ...
                "Linda Chen", AesCryptoUtil.encrypt("312-555-0302"), "Sister",
