...
public class IntegrationController {
    ...
    @PostMapping("/adt")
    public Result<Map<String, Object>> receiveAdt(@Valid @RequestBody AdtEventDTO event) {
    ...
    public Result<Map<String, Object>> receiveLabResults(@Valid @RequestBody LabResultDTO dto) {
